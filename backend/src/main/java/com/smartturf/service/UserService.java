...
/**
 * Service managing User registration, BCrypt authentication, and administration.
 * Integrates directly with MySQL 'users' table.
 */
@Service
@Transactional
public class UserService {
    ...
    public User register(RegisterRequest request) {
        ...
        // Hash password securely with BCrypt before saving to MySQL
    ...
    // Authenticate user login from MySQL users table
    public User login(LoginRequest request) {
        ...
        // Backward compatibility for legacy plain text passwords: verify and upgrade to BCrypt
    ...
    // Create user by Admin (can be ADMIN, CUSTOMER, or OWNER)
